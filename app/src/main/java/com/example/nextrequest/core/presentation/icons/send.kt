...
val Send: ImageVector
    get() {
        if (_VscodeCodiconsSend != null) return _VscodeCodiconsSend!!
        
        _VscodeCodiconsSend = ImageVector.Builder(
            name = "send",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 16f,
        ...
        return _VscodeCodiconsSend!!
    }

private var _VscodeCodiconsSend: ImageVector? = null
